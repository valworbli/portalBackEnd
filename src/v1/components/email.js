...
function sendEmail(email, newjwt, template, firstName) {
  return new Promise(function(resolve, reject) {
    ...
    if (template === 'reset') {
      let title = '[WORBLI] Password Reset';
      let url = process.env.FRONT_END_URL
      let htmlEmail = `
      <!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
      <html xmlns="http://www.w3.org/1999/xhtml">
    ...
    if (template === 'kycfail') {
      let title = '[WORBLI] Identity Verification';
      let name = firstName.charAt(0).toUpperCase() + firstName.substr(1) || '';
      let htmlEmail = `
      <!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
      <html xmlns="http://www.w3.org/1999/xhtml">
        <head>
